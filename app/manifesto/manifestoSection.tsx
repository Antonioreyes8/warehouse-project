 ...
 * Purpose: Displays the manifesto section with interactive styled text.
 * Responsibilities:
 *   - Provide the visual manifesto landing section
 *   - Embed the interactive canvas component for dynamic rendering
 * Key Concepts:
 *   - Composition of presentational layout and custom interactive content
 *   - Uses declarative React JSX to structure static page sections
 */
