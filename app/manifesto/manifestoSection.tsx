				...
				*/}
				<div>
					...
					<p>
						...
						systems that extract, isolate, and commodify human expression.
					</p>
					<br></br>
					<p>
					...
					<br></br>
					<p>
						Technofeudalism, the concept where human creativity has been
						intensely commodified makes the path to an audience increasingly
